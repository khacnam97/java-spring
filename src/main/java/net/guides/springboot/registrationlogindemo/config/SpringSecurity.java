...
public class SpringSecurity {
	...
	public WebSecurityCustomizer webSecurityCustomize() {
		return (web) -> web.ignoring().requestMatchers("/register/**","/css/**","/js/**", "/img/**", "/vendor/**");
	}
	@Bean
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((authorize) -> authorize.requestMatchers("/register/**").permitAll().anyRequest().authenticated())
